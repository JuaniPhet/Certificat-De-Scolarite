<?php 
    ...
    @$matriculeRecup=isset($_POST['matricule-recup'])?$_POST['matricule-recup']:"";
    @$nom=isset($_POST['nom-recup'])?$_POST['nom-recup']:"";
    @$datenaiss=isset($_POST['datenaissance-recup'])?$_POST['datenaissance-recup']:"";
    $requete="select * from users where matricule='$matriculeRecup'and datedenaissance='$datenaiss'";
